...
while (playquiz) {
        ...
        if (quiz.topic === "science") {
            const questions = [
                ...
                },
                {
                    name: "question2",
                    type: "list",
                    message: "Which of the following is the process by which plants make food?",
                    choices: [
                        "A) Respiration",
                        "B) Photosynthesis",
                        "C) Decomposition",
                ...
                },
                {
                    name: "question3",
                    type: "list",
                    message: " Which of the following types of rocks is formed from the cooling and solidification of magma?",
                    choices: [
                        "A) Sedimentary",
                        "B) Igneous",
                        "C) Metamorphic",
                ...
                },
                {
                    name: "question6",
                    type: "list",
                    message: "What is the scientific term for the building blocks of life?",
                ...
                },
                {
                    name: "question7",
                    type: "list",
                    message: "Which of the following scientists is credited with the discovery of gravity?",
                    choices: [
                        "A) Galileo Galilei",
                        "B) Isaac Newton",
                        "C) Albert Einstein",
                ...
                },
                {
                    name: "question8",
                    type: "list",
                    message: "What is the process by which water moves through a plant, from the roots to the leaves?",
                    choices: [
                        "A) Respiration",
                        "B) Photosynthesis",
                        "C) Transpiration",
            ...
            const questions = [
                ...
                },
                {
                    name: "question3",
                    type: "list",
                    message: " Which of the following rivers is the longest in the world?",
                ...
                },
                {
                    name: "question5",
                    type: "list",
                    message: "Which of the following countries is the largest in the world by population?",
                ...
                },
                {
                    name: "question7",
                    type: "list",
                    message: "Which of the following cities is known as the City of Light?",
                ...
                },
                {
                    name: "question8",
                    type: "list",
                    message: " Who was the famous scientist who developed the theory of gravity?",
                    choices: [
                        "A) Galileo Galilei",
                        "B) Isaac Newton",
                        "C) Albert Einstein",
    ...
    const play = await inquirer_1.default.prompt([
        {
            name: "playagain",
            type: "list",
